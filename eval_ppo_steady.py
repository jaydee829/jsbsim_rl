...
model = PPO2.load("model/ppo2_fg_steadyheading_rnn_h128_lr1e-4_f15", env=env, tensorboard_log="model/tensorboard/")

obs = env.reset()

eval_steps = 10000
obs_ds = '/steadyheading/F15/ppo2_rnn_h128_mb4_g95_thr90_lr1e-4_2/obs'
act_ds = '/steadyheading/F15/ppo2_rnn_h128_mb4_g95_thr90_lr1e-4_2/act'
