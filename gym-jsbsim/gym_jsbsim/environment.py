...
class JsbSimEnv(gym.Env):
    ...
    def render(self, mode='flightgear', flightgear_blocking=True):
        ...
        """
        # force mode to read from an env var
        import os
        mode = os.environ.get( 'GYM_JSBSIM_RENDER_MODE', 'human')
        #print( 'jsbsimenv render mode: %s' % mode )
...
class NoFGJsbSimEnv(JsbSimEnv):
    ...
    def render(self, mode='human', flightgear_blocking=True):
        #print( 'nofgjsbsimenv render mode: %s' % mode )
        if mode == 'flightgear':
